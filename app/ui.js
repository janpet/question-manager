...
$(document).on('click', '.question-edit', function () {
    ...
    var id = $(this).parent().parent().parent().find('.qlist-id').text(),
        question = $(this).parent().parent().parent().find('.qlist-question').text(),
        answer = $(this).parent().parent().parent().find('.qlist-answer').text(),
        cid =$(this).parent().parent().parent().find('.qlist-catid').text();
...
$(document).on('click', '#editOk', function () {
    var aId =$('#editId').val(),
        aQuestion= $('#editQuestion').val(),
        aAnswer= $('#editAnswer').val(),
        aCid= $('#editCat').val();
...
$(document).on('click', '#insertOk', function () {
    var inquestion =$("#insertQuestion").val(),
        inanswer =$("#insertAnswer").val(),
        incid =$("#insertModal .insertCat").val();
